...
1.  **Base de Datos:** Asegúrate de tener MySQL corriendo (puedes usar XAMPP ).
...
4.  **Ejecución:** Abre una terminal en la raíz de la carpeta del backend y ejecuta el comando:
    ```bash
    mvn spring-boot:run
    ```
